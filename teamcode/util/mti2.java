...
public class  mti2 extends LinearOpMode {
    ...
    public void runOpMode()
    {
        ...
        Trajectory SHOOT1 = drive.trajectoryBuilder(new Pose2d())
                ...
                //.splineToConstantHeading(new Vector2d(49,2.6),Math.toRadians(0))
                .splineToConstantHeading(new Vector2d(53.54,-16),Math.toRadians(0))  //53 1 0    //57.80 6.25 0
                .build();
        ...
        Trajectory WOBBLE1_1 = drive.trajectoryBuilder(SHOOT1.end().plus(new Pose2d(0,0,Math.toRadians(-9))))
                ...
                .lineToLinearHeading(new Pose2d(85,30,Math.toRadians(180)))   //-20
                .addDisplacementMarker(() ->{
                    prins.setPosition(0);
                })
                .build();
        ...
        Trajectory BB1 =  drive.trajectoryBuilder(WOBBLE1_1.end(),true)
                ...
                .lineToLinearHeading(new Pose2d(110,30,Math.toRadians(180)))
                .addDisplacementMarker(() -> {
        ...
        Trajectory BB2 = drive.trajectoryBuilder(BB1.end().plus(new Pose2d(0,0,Math.toRadians(-90))),true)
                //.lineToLinearHeading(new Pose2d(118,29,Math.toRadians(135)))
                .lineToLinearHeading(new Pose2d(118,-30,Math.toRadians(135)))
                /*.addDisplacementMarker(() -> {
        ...
        Trajectory SHOOT_M6 = drive.trajectoryBuilder(BB3.end(),true)
                .lineToLinearHeading(new Pose2d(52,10,Math.toRadians(-37)))
                .addDisplacementMarker(() -> {
        ...
        Trajectory M6MAFIA = drive.trajectoryBuilder(BB2.end().plus(new Pose2d(0,0,90)))
        ...
        Trajectory PARK1 = drive.trajectoryBuilder(SHOOT_M6.end(),true)
                .splineToLinearHeading(new Pose2d(66, -15,Math.toRadians(180)),Math.toRadians(180))
                .build();
        ...
        Trajectory WOBBLE2_1 = drive.trajectoryBuilder(SHOOT2_2.end())
                ...
                .lineToLinearHeading(new Pose2d(105,10,Math.toRadians(180)))
                .addDisplacementMarker(() ->{
                    prins.setPosition(0);
                })
                .build();
        ...
        Trajectory BB2_1 =  drive.trajectoryBuilder(WOBBLE2_1.end(),true)
                ...
                .lineToLinearHeading(new Pose2d(111,30,Math.toRadians(180)))
                .addDisplacementMarker(() -> {
                    drive.prins.setPosition(0.8);
                })
                .build();
        ...
        Trajectory BB3_1 =  drive.trajectoryBuilder(SHOOT1.end().plus(new Pose2d(0,0,Math.toRadians(180))),true)
                ...
                .lineToLinearHeading(new Pose2d(115,-22,Math.toRadians(180)))
                .addDisplacementMarker(() ->{

                })
                .build();

        Trajectory BB3_2 = drive.trajectoryBuilder(BB3_1.end().plus(new Pose2d(0,0,Math.toRadians(135))),true)
                .lineToLinearHeading(new Pose2d(115,25,Math.toRadians(45)))
                .addDisplacementMarker(()->{
                    brat.setTargetPosition((int)((2786.2/360)*170));
                    brat.setPower(0.3);
                })
...
/*
        ...
        Trajectory BB3_5 = drive.trajectoryBuilder(SHOOT1.end().plus(new Pose2d(0,0,Math.toRadians(-55))),true)
                .splineToLinearHeading(new Pose2d(124,32,Math.toRadians(90)),Math.toRadians(180))
                .build();

        Trajectory SHOOT_M62 = drive.trajectoryBuilder(BB3.end(),true)
                .lineToLinearHeading(new Pose2d(52,10,Math.toRadians(-37)))
                .addDisplacementMarker(() -> {
                    drive.intake.setPower(0);
                    drive.rintake.setPosition(0);
                ...
                .build();
*/
        Trajectory BB3_3 = drive.trajectoryBuilder(BB3_2.end().plus(new Pose2d(0,0,Math.toRadians(-90))),true)
                .addDisplacementMarker(() -> {
                ...
                .splineToLinearHeading(new Pose2d(52,-20,Math.toRadians(15)),Math.toRadians(180)) // 52 -15
                .addDisplacementMarker(() -> {
                    drive.intake.setPower(0);
                    drive.rintake.setPosition(0);
                    drive.intake2.setPower(0);
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        while(!isStarted())
        {
            ...
            if(pipeline.position==mti2.SkystoneDeterminationPipeline.RingPosition.FOUR)
                nrAUTO=3;
            else if(pipeline.position==mti2.SkystoneDeterminationPipeline.RingPosition.ONE)
                nrAUTO=2;
            else
                nrAUTO=1;
    ...
    public static class SkystoneDeterminationPipeline extends OpenCvPipeline
    {
         ...
         */
        static final Point REGION1_TOPLEFT_ANCHOR_POINT = new Point(340,980);  //////////////////  550  338
        ...
        private volatile mti2.SkystoneDeterminationPipeline.RingPosition position = mti2.SkystoneDeterminationPipeline.RingPosition.FOUR;
        ...
        public Mat processFrame(Mat input)
        {
            ...
            position = mti2.SkystoneDeterminationPipeline.RingPosition.FOUR; // Record our analysis
            if(avg1 > FOUR_RING_THRESHOLD){
                position = mti2.SkystoneDeterminationPipeline.RingPosition.FOUR;
            }else if (avg1 > ONE_RING_THRESHOLD){
                position = mti2.SkystoneDeterminationPipeline.RingPosition.ONE;
            }else{
                position = mti2.SkystoneDeterminationPipeline.RingPosition.NONE;
            }

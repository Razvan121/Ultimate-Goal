...
public class mti4 extends LinearOpMode {
    ...
    public void runOpMode()
    {
        ...
        Trajectory SHOOT2 = drive.trajectoryBuilder(SHOOT1.end())
                .lineToLinearHeading(new Pose2d(53,4,Math.toRadians(-28)) )
                .build();


        Trajectory WOBBLE1_1 = drive.trajectoryBuilder(SHOOT2.end().plus(new Pose2d(0,0,Math.toRadians(-9))))
                .addDisplacementMarker(() ->{
                    brat.setTargetPosition((int)((2786.2/360)*170));
                    brat.setPower(0.3);
                })
                .lineToLinearHeading(new Pose2d(51,1,Math.toRadians(45)))
                .addDisplacementMarker(() ->{
                    prins.setPosition(0);
                })
                .build();
...
/*
        ...
        Trajectory WOBBLE1_2 = drive.trajectoryBuilder(WOBBLE1_BACK2.end())
                ...
                .build();
*/
        Trajectory INTERMEDIAR = drive.trajectoryBuilder(WOBBLE1_1.end(),true)
        ...
        Trajectory PARK1 = drive.trajectoryBuilder(INTERMEDIAR.end(),true)
                ...
                .splineToLinearHeading(new Pose2d(65, -15,Math.toRadians(180)),Math.toRadians(180))  //-40
                .build();
        ...
        Trajectory SHOOT2_1 = drive.trajectoryBuilder(new Pose2d())
                ...
                .splineToConstantHeading(new Vector2d(41,-1),Math.toRadians(0))
                .splineToConstantHeading(new Vector2d(53.54,-18),Math.toRadians(-15)) //53 1 0    //57.80 6.25 0
                .build();
        ...
        Trajectory WOBBLE2_1 = drive.trajectoryBuilder(SHOOT2_2.end())
                ...
                .lineToLinearHeading(new Pose2d(86,-10,Math.toRadians(0)))
                .addDisplacementMarker(() ->{
                    prins.setPosition(0);
                })
                .build();
...
*/
        ...
        Trajectory PARK2 = drive.trajectoryBuilder(WOBBLE2_1.end(),true)
                ...
                .splineToLinearHeading(new Pose2d(65, -10,Math.toRadians(180)),Math.toRadians(180))  //0
                .build();
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        Trajectory INCEPUT_INTAKE = drive.trajectoryBuilder(SHOOT3_1.end())
                ...
                .addDisplacementMarker(() -> {
                    ...
                    // drive.m6.setVelocity(1450);
                })

                .build();

     /*   Trajectory BACK3_1 = drive.trajectoryBuilder(INCEPUT_INTAKE.end())
                .addDisplacementMarker(() -> {
                    drive.intake.setPower(1);
                })
                .back(5) //20
        ...
        Trajectory BACK3_2 = drive.trajectoryBuilder(BACK3_1.end())
                .addDisplacementMarker(() -> {
                    drive.intake.setPower(1);
                })
                .back(8) //10
                .addDisplacementMarker(() -> {
                    drive.m6.setVelocity(1720);
                })
                .addDisplacementMarker(() -> {
                    drive.intake.setPower(0);
                })
...
//////////////////////////////////////////////////////////////////////////////////////////
        Trajectory WOBBLE3_1_1 = drive.trajectoryBuilder(SHOOT3_2.end())
                ...
                .lineToLinearHeading(new Pose2d(108,6.6,Math.toRadians(0)))
                .addDisplacementMarker(() ->{
                    prins.setPosition(0);
                })
                .build();
////////////////////////////////////////////////////////////////////////////////////////////////////
        Trajectory WOBBLE3_BACK1 = drive.trajectoryBuilder(SHOOT3_2.end(),true)
                .addDisplacementMarker(() -> {
                    drive.intake.setPower(0);
                    brat.setTargetPosition((int)((2786.2/360)*170));
                    brat.setPower(0.3);
                ...
                .lineToLinearHeading(new Pose2d(31,-18,Math.toRadians(180)))  //31
                .build();

        Trajectory WOBBLE3_BACK2 = drive.trajectoryBuilder(WOBBLE3_BACK1.end())
        ...
        Trajectory WOBBLE3_2 = drive.trajectoryBuilder(WOBBLE3_BACK2.end())
                .lineToLinearHeading(new Pose2d(105,-10,Math.toRadians(0)))
                .addDisplacementMarker(() ->{
                    prins.setPosition(0);
                })
                .build();
        ...
        Trajectory PARK3 = drive.trajectoryBuilder(WOBBLE3_1_1.end())
                ...
                .lineToLinearHeading(new Pose2d(75, -10 ,Math.toRadians(180)))  //0
                .build();
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        pipeline = new mti4.SkystoneDeterminationPipeline();
        ...
        while(!isStarted())
        {
            ...
            if(pipeline.position==mti4.SkystoneDeterminationPipeline.RingPosition.FOUR)
                nrAUTO=3;
            else if(pipeline.position==mti4.SkystoneDeterminationPipeline.RingPosition.ONE)
                nrAUTO=2;
            else
                nrAUTO=1;
    ...
    public static class SkystoneDeterminationPipeline extends OpenCvPipeline
    {
         ...
         */
        static final Point REGION1_TOPLEFT_ANCHOR_POINT = new Point(850,970);  //////////////////  550  338
        ...
        private volatile mti4.SkystoneDeterminationPipeline.RingPosition position = mti4.SkystoneDeterminationPipeline.RingPosition.FOUR;
        ...
        public Mat processFrame(Mat input)
        {
            ...
            position = mti4.SkystoneDeterminationPipeline.RingPosition.FOUR; // Record our analysis
            if(avg1 > FOUR_RING_THRESHOLD){
                position = mti4.SkystoneDeterminationPipeline.RingPosition.FOUR;
            }else if (avg1 > ONE_RING_THRESHOLD){
                position = mti4.SkystoneDeterminationPipeline.RingPosition.ONE;
            }else{
                position = mti4.SkystoneDeterminationPipeline.RingPosition.NONE;
            }

...
public class Auto0 extends LinearOpMode {
    ...
    Auto0.SkystoneDeterminationPipeline pipeline;
    ...
    public void runOpMode()
    {
        ...
        Trajectory SHOOT1 = drive.trajectoryBuilder(new Pose2d())
                ...
                .splineToConstantHeading(new Vector2d(57.80,9),Math.toRadians(0))
                .build();
        ...
        Trajectory WOBBLE1_1 = drive.trajectoryBuilder(SHOOT1.end().plus(new Pose2d(0,0,Math.toRadians(-9))))
                ...
                .lineToLinearHeading(new Pose2d(65,-15,Math.toRadians(-5.4)))
                .addDisplacementMarker(() ->{
                    prins.setPosition(0);
                })
                .build();
        ...
        Trajectory SHOOT2_2 = drive.trajectoryBuilder(discBACK.end())
                .lineToLinearHeading(new Pose2d(53,1,Math.toRadians(-9)))
                .build();
        ...
        Trajectory SHOOT3_2 = drive.trajectoryBuilder(BACK3_5.end())
                .splineToLinearHeading(new Pose2d(49,1,Math.toRadians(-7)),Math.toRadians(0))
                .addDisplacementMarker(() -> {
    })
                .build();
        ...
        Trajectory WOBBLE3_1_1 = drive.trajectoryBuilder(SHOOT3_2.end())
                ...
                .lineToLinearHeading(new Pose2d(112,-13,Math.toRadians(0)))
                .addDisplacementMarker(() ->{
                    prins.setPosition(0);
                })
                .build();
        ...
        Trajectory PARK3 = drive.trajectoryBuilder(WOBBLE3_1_1.end())
                ...
                .lineToLinearHeading(new Pose2d(75, -10 ,Math.toRadians(175)))
                .build();
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        pipeline = new Auto0.SkystoneDeterminationPipeline();
        ...
        while(!isStarted())
        {
            ...
            if(pipeline.position==Auto0.SkystoneDeterminationPipeline.RingPosition.FOUR)
                nrAUTO=3;
            else if(pipeline.position==Auto0.SkystoneDeterminationPipeline.RingPosition.ONE)
                nrAUTO=2;
            else
                nrAUTO=1;
...
telemetry.update();
    ...
    public static class SkystoneDeterminationPipeline extends OpenCvPipeline
    {
         ...
         */
        static final Point REGION1_TOPLEFT_ANCHOR_POINT = new Point(350,950);
        ...
        private volatile Auto0.SkystoneDeterminationPipeline.RingPosition position = Auto0.SkystoneDeterminationPipeline.RingPosition.FOUR;
        ...
        public Mat processFrame(Mat input)
        {
            ...
            position = Auto0.SkystoneDeterminationPipeline.RingPosition.FOUR; // Record our analysis
            if(avg1 > FOUR_RING_THRESHOLD){
                position = Auto0.SkystoneDeterminationPipeline.RingPosition.FOUR;
            }else if (avg1 > ONE_RING_THRESHOLD){
                position = Auto0.SkystoneDeterminationPipeline.RingPosition.ONE;
            }else{
                position = Auto0.SkystoneDeterminationPipeline.RingPosition.NONE;
            }

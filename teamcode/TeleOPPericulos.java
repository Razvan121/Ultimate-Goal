...
@TeleOp
public class TeleOPPericulos extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException{
        ...
        drive.setPoseEstimate(new Pose2d(65,20,Math.toRadians(180)));   //180   //65 20 180
        //52.68 3.97 5.93

        //drive.telefon.setPosition(0.5);
        ...
        while(opModeIsActive() && !isStopRequested())
        {
            ...
            telemetry.addData("pozitie telefon", drive.telefon.getPosition());
            telemetry.update();
...
/////////////////////////////////////////////////////////   POWERSHOTS -- ENDGAME   ///////////////////////////////////////////////////
            /*        if(gamepad1.y) {
                        drive.setPoseEstimate(new Pose2d(53.62, -18.39, Math.toRadians(0)));   //53.62  -18.39  0
                        Trajectory POWERSHOTS = drive.trajectoryBuilder(poseEstimate)
                                .addDisplacementMarker(() ->
                                {
                                    drive.m6.setVelocity(1550);
                                })
                                .lineToLinearHeading(new Pose2d(57.80, 6.25, Math.toRadians(-10)))
                                .build();
...
/////////////////////////////////////////////////////////////    TRAS -- AUTO    ////////////////////////////////////////////////////
                    ...
                    {
                        drive.m6.setVelocity(1700);    /////////////1800
                        mod=false;
                    }
...
/*
                    if(gamepad1.a)
                    {
                        Trajectory trage = drive.trajectoryBuilder(poseEstimate)
                                .lineToLinearHeading(new Pose2d(57.59,8.58,Math.toRadians(-6)))//53.62,-18.39
                                .build();
                        drive.followTrajectory(trage);
                    }
*/
///////////////////////////////////////////////////   MERS   //////////////////////////////////////////////

...
public class Auto2 extends LinearOpMode {
    ...
    Auto2.SkystoneDeterminationPipeline pipeline;
    ...
    public void runOpMode()
    {
        ...
        Trajectory SHOOT1 = drive.trajectoryBuilder(new Pose2d())
                ...
                .splineToSplineHeading(new Pose2d(53.54,2.6,Math.toRadians(-24)),Math.toRadians(0))
        ...
        Trajectory WOBBLE1_1 = drive.trajectoryBuilder(SHOOT1.end().plus(new Pose2d(0,0,Math.toRadians(-9))))
                ...
                .lineToLinearHeading(new Pose2d(68,27,Math.toRadians(45)))
                .addDisplacementMarker(() ->{
                    prins.setPosition(0);
                })
                .build();
...
*/
        ...
        Trajectory PARK1 = drive.trajectoryBuilder(WOBBLE1_1.end(),true)
                ...
                .splineToLinearHeading(new Pose2d(65, -20,Math.toRadians(180)),Math.toRadians(180))
                .build();
        ...
        Trajectory SHOOT2_1 = drive.trajectoryBuilder(new Pose2d())
                ...
                .splineToConstantHeading(new Vector2d(53.54,2.6),Math.toRadians(0))  //53 1 0    //57.80 6.25 0
                .build();
        ...
        Trajectory SHOOT2_2 = drive.trajectoryBuilder(discBACK.end())
                .lineToLinearHeading(new Pose2d(53,1,Math.toRadians(-13)))
                .build();
        ...
        Trajectory WOBBLE2_1 = drive.trajectoryBuilder(SHOOT2_2.end())
                ...
                .lineToLinearHeading(new Pose2d(88,5,Math.toRadians(0)))
                .addDisplacementMarker(() ->{
                    prins.setPosition(0);
                })
                .build();
...
*/
        ...
        Trajectory PARK2 = drive.trajectoryBuilder(WOBBLE2_1.end(),true)
                ...
                .splineToLinearHeading(new Pose2d(65, -20,Math.toRadians(180)),Math.toRadians(180))  //0
                .build();
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        Trajectory INCEPUT_INTAKE = drive.trajectoryBuilder(SHOOT3_1.end())
                .lineToLinearHeading(new Pose2d(50,6,Math.toRadians(0)))
                .addDisplacementMarker(() -> {
...
*/
        ...
        Trajectory SHOOT3_2 = drive.trajectoryBuilder(BACK3_5.end())
                .splineToLinearHeading(new Pose2d(53,1,Math.toRadians(-10)),Math.toRadians(0))
                .build();
//////////////////////////////////////////////////////////////////////////////////////////
        Trajectory WOBBLE3_1_1 = drive.trajectoryBuilder(SHOOT3_2.end())
                ...
                .lineToLinearHeading(new Pose2d(110,32,Math.toRadians(0)))
                .addDisplacementMarker(() ->{
                    prins.setPosition(0);
                })
                .build();
////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        Trajectory PARK3 = drive.trajectoryBuilder(WOBBLE3_1_1.end())
                ...
                .lineToLinearHeading(new Pose2d(75, -5 ,Math.toRadians(175)))  //0
                .build();
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        pipeline = new Auto2.SkystoneDeterminationPipeline();
        ...
        while(!isStarted())
        {
            ...
            if(pipeline.position==Auto2.SkystoneDeterminationPipeline.RingPosition.FOUR)
                nrAUTO=3;
            else if(pipeline.position==Auto2.SkystoneDeterminationPipeline.RingPosition.ONE)
                nrAUTO=2;
            else
                nrAUTO=1;
    ...
    public static class SkystoneDeterminationPipeline extends OpenCvPipeline
    {
         ...
         */
        static final Point REGION1_TOPLEFT_ANCHOR_POINT = new Point(290,1000);  //////////////////  550  338

        static final int REGION_WIDTH = 145;   /////////////////
        static final int REGION_HEIGHT = 185;  /////////////////
        ...
        private volatile Auto2.SkystoneDeterminationPipeline.RingPosition position = Auto2.SkystoneDeterminationPipeline.RingPosition.FOUR;
        ...
        public Mat processFrame(Mat input)
        {
            ...
            position = Auto2.SkystoneDeterminationPipeline.RingPosition.FOUR; // Record our analysis
            if(avg1 > FOUR_RING_THRESHOLD){
                position = Auto2.SkystoneDeterminationPipeline.RingPosition.FOUR;
            }else if (avg1 > ONE_RING_THRESHOLD){
                position = Auto2.SkystoneDeterminationPipeline.RingPosition.ONE;
            }else{
                position = Auto2.SkystoneDeterminationPipeline.RingPosition.NONE;
            }

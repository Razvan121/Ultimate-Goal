 ...
 */
@Config
public class NEDBOT extends MecanumDrive {
    ...
    public static double LATERAL_MULTIPLIER = 1.666666;

    public static double VX_WEIGHT = 1;
    public static double VY_WEIGHT = 1;
    public static double OMEGA_WEIGHT = 1;

    public static final double GHIARA_STRANS = 0.8;
    public static final double GHIARA_LARG = 0;
    public static final double TRAGACI_FATA = 0.5;
    public static final double TRAGACI_SPATE = 0.8;
   ...
   public Servo alberto;
    public CRServo tobesec;
    ...
    public NEDBOT(HardwareMap hardwareMap) {
...
*/
        ...
        //alberto = hardwareMap.get(Servo.class, "alberto");
        //bosinceanu = hardwareMap.get(Servo.class, "bosinceanu");
       // tobesec = hardwareMap.get(CRServo.class, "tobesec");

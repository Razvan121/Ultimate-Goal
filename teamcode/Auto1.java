...
public class Auto1 extends LinearOpMode {
    ...
    Auto1.SkystoneDeterminationPipeline pipeline;
    ...
    public void runOpMode()
    {
        ...
        Trajectory WOBBLE1_1 = drive.trajectoryBuilder(SHOOT1.end().plus(new Pose2d(0,0,Math.toRadians(-9))))
                ...
                .lineToLinearHeading(new Pose2d(68,-42,Math.toRadians(-10)))
                .addDisplacementMarker(() ->{
                    prins.setPosition(0);
                })
                .build();
        ...
        Trajectory WOBBLE2_1 = drive.trajectoryBuilder(SHOOT2_2.end())
                ...
                .lineToLinearHeading(new Pose2d(90.5,-25,Math.toRadians(0)))
                .addDisplacementMarker(() ->{
                    prins.setPosition(0);
                })
                .build();
        ...
        Trajectory SHOOT3_1_1 = drive.trajectoryBuilder(new Pose2d())
                ...
                .splineToConstantHeading(new Vector2d(54,-2),Math.toRadians(0))
                .splineToConstantHeading(new Vector2d(57.50,-19.9),Math.toRadians(0))
                .build();



        Trajectory INCEPUT_INTAKE = drive.trajectoryBuilder(SHOOT3_1_1.end())
                .lineToLinearHeading(new Pose2d(54,-15,Math.toRadians(0)))
                .addDisplacementMarker(() -> {
        ...
        Trajectory BACK3_2 = drive.trajectoryBuilder(INCEPUT_INTAKE.end(),true)
                .splineToLinearHeading( new Pose2d(37,-15,Math.toRadians(0)),Math.toRadians(0))
                .build();
        ...
        Trajectory SHOOT3_2 = drive.trajectoryBuilder(BACK3_5.end())
                .splineToLinearHeading(new Pose2d(53,-19.25,Math.toRadians(-11)),Math.toRadians(0))
                .build();
        ...
        Trajectory WOBBLE3_1_1 = drive.trajectoryBuilder(SHOOT3_2.end())
                ...
                .lineToLinearHeading(new Pose2d(105,-40,Math.toRadians(0)))
                .addDisplacementMarker(() ->{
                    prins.setPosition(0);
                })
                .build();
        ...
        Trajectory PARK3 = drive.trajectoryBuilder(WOBBLE3_1_1.end())
                ...
                .lineToLinearHeading(new Pose2d(66, -10 ,Math.toRadians(175)))
                .build();
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        while(!isStarted())
        {
            ...
            if(pipeline.position==Auto1.SkystoneDeterminationPipeline.RingPosition.FOUR)
                nrAUTO=3;
            else if(pipeline.position==Auto1.SkystoneDeterminationPipeline.RingPosition.ONE)
                nrAUTO=2;
            else
                nrAUTO=1;
    ...
    public static class SkystoneDeterminationPipeline extends OpenCvPipeline
    {
         ...
         */
        static final Point REGION1_TOPLEFT_ANCHOR_POINT = new Point(770,1000);
        ...
        private volatile Auto1.SkystoneDeterminationPipeline.RingPosition position = Auto1.SkystoneDeterminationPipeline.RingPosition.FOUR;
        ...
        public Mat processFrame(Mat input)
        {
            ...
            position = Auto1.SkystoneDeterminationPipeline.RingPosition.FOUR; // Record our analysis
            if(avg1 > FOUR_RING_THRESHOLD){
                position = Auto1.SkystoneDeterminationPipeline.RingPosition.FOUR;
            }else if (avg1 > ONE_RING_THRESHOLD){
                position = Auto1.SkystoneDeterminationPipeline.RingPosition.ONE;
            }else{
                position = Auto1.SkystoneDeterminationPipeline.RingPosition.NONE;
            }
